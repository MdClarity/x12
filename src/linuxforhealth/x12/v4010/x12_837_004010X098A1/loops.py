...
class Loop2010Aa(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2010AaRefSegment]] = Field(
...
class Loop2010Ab(X12SegmentGroup):
    ...
    n3_segment: N3Segment
    n4_segment: N4Segment
    ref_segment: Optional[List[Loop2010AbRefSegment]] = Field(
...
class Loop2010Ba(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2010BaRefSegment]] = Field(
        default=None, max_length=5
    )
...
class Loop2010Bd(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2010BdRefSegment]] = Field(
        default=None, max_length=2
    )
