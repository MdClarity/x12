...
class Loop2120D(X12SegmentGroup):
    ...
    per_segment: Optional[List[PerSegment]] = Field(
...
class Loop2115D(X12SegmentGroup):
    ...
    loop_2120c: Optional[List[Loop2120D]] = Field(
        default=None, min_length=0, max_length=23
    )
...
class Loop2110D(X12SegmentGroup):
    ...
    hsd_segment: Optional[List[HsdSegment]] = Field(
        default=None, min_length=0, max_length=9
    )
    ...
    msg_segment: Optional[List[MsgSegment]] = Field(
        default=None, min_length=0, max_length=10
    )
    loop_2115d: Optional[List[Loop2115D]] = Field(
        default=None, min_length=0, max_length=10
    )
    ls_segment: Optional[LsSegment] = None
    loop_2120d: Optional[List[Loop2120D]] = Field(
        default=None, min_length=0, max_length=23
    )
...
class Loop2000D(X12SegmentGroup):
    ...
    trn_segment: Optional[List[TrnSegment]] = Field(
...
class Loop2115C(X12SegmentGroup):
    ...
    iii_segment: IiiSegment
    ls_segment: LsSegment
    loop_2120c: Optional[List[Loop2120C]] = Field(
        default=None, min_length=0, max_length=23
    )
    le_segment: LeSegment
...
class Loop2110C(X12SegmentGroup):
    ...
    loop_2115c: Optional[List[Loop2115C]] = Field(
        default=None, min_length=0, max_length=10
    )
    ls_segment: Optional[LsSegment] = None
    loop_2120c: Optional[List[Loop2120C]] = Field(
...
class Loop2100A(X12SegmentGroup):
    ...
    prv_segment: Optional[List[PrvSegment]] = Field(
        default=None, min_length=0, max_length=3
    )
